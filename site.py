...
from site_utils import present_image, concatenate_values
...
if st.button("Generate"):
    ...
    try:
        ...
        card["name"] = name_selection
        #card["text"] = generate_text(concatenate_values(card))
        present_image(st, card)
        st.markdown("Note that the 'M' in the mana cost refers to any mana.")
